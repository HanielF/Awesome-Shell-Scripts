...
echo "======Usage: batch_ln dir1 dir2 file_type======"
...
do
  ...
  if [ -f $tar_path/$file_name ];then
    read -p "Do you want to replace the existing file link (Y/N):" ans
  ...
  # create current file link
  sudo ln ${i}  $tar_path/$file_name
...
# exit script
echo "======Finish Creating File Links======"
